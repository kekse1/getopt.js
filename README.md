...
## News
* \[**2025-08-20**\] Updated the [**`getopt.tiny.js`**](#tiny-alternative-version), v**2.4.2**;
...
* [**`getopt.tiny.js`**](src/getopt.tiny.js), v**2.4.2** (updated **2025-08-20**, w/ **679** code lines in total);
